...
def make_mikuji(text):
    ...
    #元画像を読み込んでくる場合
    image = Image.open("https://hackathon-engineer-omikuji.herokuapp.com/static/mikuji/base.jpg")
    ...
    #出来上がった画像を保存する
    image.save(f"https://hackathon-engineer-omikuji.herokuapp.com/static/mikuji/result{no}.jpg")
